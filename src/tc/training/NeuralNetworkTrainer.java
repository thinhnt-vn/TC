...
public class NeuralNetworkTrainer implements Trainable {
    ...
    public NeuralNetworkTrainer(double threshold) {
...
//                Document doc = dataSet.get(index);
...
//                        tranferFunction::tranfer);
                ...
                Matrix delta = outL2.plus(doc.getLabel());
                e += 0.5 * delta.times(delta.transpose()).get(0, 0);

                Matrix composedErrL2 = doc.getLabel().minus(outL2);//1x4
                Matrix errL2 = err(outL2, composedErrL2);//1x4
        ...
        return new NeuralNetworkModel(w1, w2, tranferFunction, metaData);
    }
